...
class StaticData:
    ...
    BaseColorDefault = (0.0,0.0,0.0,0.0)
    AlphaDefault = False
...
Mode of cleaning you're hovering on""",default = "ez")
    ...
    ResolutionSet : bpy.props.EnumProperty(
        name = "",
        items = [("Stan", "Standard Set", "The Set of Standard image sizes like 8,16,32,64,128,256..."),("Inter", "Intermediate Set", "The Standard Set with Intermediate image sizes like 8,16,24,32,48,64,96..."),("Mini", "Smallest Possible", "The smallest image size possible, not following any set.")],
